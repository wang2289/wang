...
let pageConfig = {
  ...
  onLoad: function (options) {
    ...
    if (chatTo === this.data.userInfo.account) {
      ...
      chatToLogo = card.avatar || this.data.defaultUserLogo
  ...
  lookAdvancedGroupInfo() {
    ...
    wx.navigateTo({
      url: `../advancedGroupCard/advancedGroupCard?teamId=${this.data.chatTo}&chatToLogo=${encodeURIComponent(this.data.chatToLogo)}&from=${this.data.from}`,
    })
  },
  /**
   * 查看讨论组信息
  ...
  lookNormalGroupInfo() {
    ...
    wx.navigateTo({
      url: `../normalGroupCard/normalGroupCard?teamId=${this.data.chatTo}&chatToLogo=${encodeURIComponent(this.data.chatToLogo)}&from=${this.data.from}`,
    })
  },
  /**
   * 弹框 确认 清除本地记录
  ...
  lookAllMessage() {
    wx.navigateTo({
      url: `../historyFromCloud/historyFromCloud?account=${this.data.chatTo}&chatToLogo=${encodeURIComponent(this.data.chatToLogo)}&chatType=${this.data.chatType}`,
    })
  },
  /**
   * 清除本地记录
...
let mapStateToData = (state) => {
  ...
  console.log(state.rawMessageList[sessionId]);
  return {
